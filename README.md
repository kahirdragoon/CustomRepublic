...
If you want more control you use xml patches to add FactionExtension_SenatorInfoExtended via the [https://rimworldwiki.com/wiki/Modding_Tutorials/PatchOperations#PatchOperationAddModExtension](PatchOperationAddModExtension) operation. FactionExtension_SenatorInfoExtended is essentially the them as the FactionExtension_SenatorInfo from VFE Classical with additionally the pawnkind field.
